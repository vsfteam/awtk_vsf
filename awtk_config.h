...
#ifndef API_PTR_EXTERN
#define API_PTR_EXTERN

extern void * (*malloc_impl)(size_t size);
extern void * (*realloc_impl)(void *p, size_t size);
extern void (*free_impl)(void *p);
extern int (*printf_impl)(const char *format, ...);
extern int (*strcasecmp_impl)(const char *s1, const char *s2);
extern int (*vsnprintf_impl)(char* str, size_t size, const char* format, va_list ap);
extern int (*vsscanf_impl)(const char *str, const char *format, va_list ap);

extern void (*sleep_ms_impl)(uint32_t ms);

extern ret_t (*platform_prepare_impl)(void);
extern uint64_t (*get_time_ms64_impl)(void);
